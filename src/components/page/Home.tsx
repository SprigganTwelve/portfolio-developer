               ...
               >
                    <div className="max-w-7xl mx-auto px-4 py-5 w-full">
                         <div className="flex flex-row flex-wrap items-center justify-center gap-8 lg:gap-20">
                              ...
                              <div>
                                   {/* Status badge */}
                                   <div className="inline-flex items-center gap-2 mb-6 bg-primary-end font-mono border-2 px-4 py-1.5 neo-tag neo-tag-blue text-xs">
                                        <span
                                   ...
                                   <h1 className="font-display text-5xl md:text-7xl leading-[1.05] mb-4">
                                        <span className="text-primary-gradient tracking-tight">Zouayobo</span>
                                        <br />
                                        <span className="tracking-tight">DALI</span>
                                   </h1>

                                   <div className="text-xl md:text-2xl font-body font-semibold mb-5 inline-block bg-primary-start shadow-md border-2 px-4 py-1">
                                        Développeur Full-Stack
                                   </div>

                                   <p className="text-base md:text-lg font-body leading-relaxed mb-5 max-w-lg text-muted">
                                        Étudiant en Bachelor Full-Stack à l&apos;IPSSI, passionné par la création
                                        d&apos;applications web et mobiles modernes. Je conçois des expériences
                                        numériques complètes, du back-end à l'interface utilisateur.
                                   </p>
